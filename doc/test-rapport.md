...
Vi har gjort brug af tests i alle tre lag i vores projekt, men vi har flere unit og service tests end UI-tests. Som Martin Fowler beskriver det i sin [artikel](https://martinfowler.com/bliki/TestPyramid.html) bør UI-test være et <i>”second line of defence”</i>, og ikke det primære grundlag for tests. 
